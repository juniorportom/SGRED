# -*- coding: utf-8 -*--
# Generated by Django 1.11.15 on 2018-11-26 03:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Fecha', models.DateTimeField(default=django.utils.datetime_safe.datetime.now)),
        ...
        migrations.CreateModel(
            name='Entregable',
            fields=[
                ('IdEntregable', models.AutoField(primary_key=True, serialize=False)),
                ('Nombre', models.CharField(max_length=255)),
                ('Version', models.IntegerField(default=0)),
                ('ComentarioVersion', models.CharField(max_length=255)),
                ('VideoURL', models.URLField()),
                ('FechaModificacion', models.DateTimeField(default=django.utils.datetime_safe.datetime.now)),
            ],
        ),
        migrations.CreateModel(
            name='Etapa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FechaSolicitud', models.DateTimeField(default=django.utils.datetime_safe.datetime.now)),
                ('Estado', models.CharField(choices=[('WAITING', 'Pendiente'), ('PROCESS', 'En Proceso'), ('DONE', 'Terminado')], max_length=255)),
                ('ComentarioApertura', models.CharField(max_length=255)),
                ('Entregable', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='QueVideo.Entregable')),
        ...
        migrations.AddField(
            ...
            name='Recurso',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='QueVideo.Recurso'),
        ),
        migrations.AddField(
            model_name='crudo',
            name='etiqueta',
        ...
        migrations.AddField(
            ...
            name='Ticket',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='QueVideo.ticketCalidad'),
        ),
        migrations.AddField(
